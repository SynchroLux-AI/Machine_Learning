...
4. <b> Evaluation </b>:
   - Compare the clustering results with the actual species labels (if available) to evaluate the performance. Metrics like <b> Adjusted Rand Index (ARI) <b> or <b><font color=blue> Silhouette Score </font><b> can be used.
